 ...
 */
public class RepeatMusicReader {
  /**
   ...
   * @return a constructed T object
   */
  public static <T> T parseFile(Readable readable, RepeatBuilder<T> piece) {
      ...
      switch (lineType) {
        ...
        case "repeat-start":
          try {
            ...
            piece.addGoToStartOnceRepeat(beat);
          } catch (NoSuchElementException e) {
        ...
        case "repeat-from":
          try {
            ...
            piece.addGoToBeatOnceRepeat(beat, goTo);
          } catch (NoSuchElementException e) {
            throw new IllegalArgumentException("Malformed repeat line: " + scanner.nextLine());
          }
          break;
        case "repeat-alternate":
          try {
            int goBackAt = scanner.nextInt();
            int goBackTo = scanner.nextInt();
            int skipAt = scanner.nextInt();
            piece.addSkipSection(goBackAt, goBackTo, skipAt);
          } catch (NoSuchElementException e) {
            throw new IllegalArgumentException("Malformed repeat line: " + scanner.nextLine());
          }
          break;
